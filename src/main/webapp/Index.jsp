					...
					<div class="inner">
						<div class="banner-content">
							...
							<div class="banner-price">
								馬上開始<span class="number-price"></span>
							</div>
	...
	<div>
		<div class="fullwidth-template">
			<div class="teamo-product produc-featured rows-space-65">
				<div class="container">
					<a href="CourseServlet1"><h3 class="custommenu-title-blog">課程
						</h3></a>
				...
				<div class="row">
					...
					<div class="box-footer col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<div class="teamo-custommenu default">
							<h2 class="widgettitle">關於我們</h2>
							<ul class="menu">
								<li class="menu-item"><a href="#">加入我們</a></li>
								<li class="menu-item"><a href="#">聯繫我們</a></li>
								<li class="menu-item"><a href="#">使用者條款</a></li>
								<li class="menu-item"><a href="#">服務契約</a></li>
								<li class="menu-item"><a href="#">隱私權政策 </a></li>
							</ul>
						</div>
					</div>
					<div
						...
						<div class="teamo-newsletter style1">
							...
							<div class="newsletter-form-wrap">
								<div class="list">
									馬上註冊獲取更多免費課程<br />以及最新活動消息
								</div>
								<input type="email" class="input-text email email-newsletter"
									placeholder="輸入你的信箱">
								<button class="button btn-submit submit-newsletter">訂閱我們</button>
							</div>
						</div>
					</div>
					<div class="box-footer col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<div class="teamo-custommenu default">
							...
							<ul class="menu">
								<li class="menu-item"><a href="#">我要開課</a></li>
								<li class="menu-item"><a href="#">我要上傳試卷</a></li>
								<li class="menu-item"><a href="#">常見問題</a></li>
								<li class="menu-item"><a href="#">線上課程折價券</a></li>
								<li class="menu-item"><a href="#">填課前問卷拿優惠</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							...
							<div class="coppyright">
								Copyright © 2020 <a href="http://www.bootstrapmb.com/"> good
									student</a>. All rights reserved
							</div>
						</div>
					</div>
				</div>
		...
		<div class="wapper">
			...
			<div class="footer-device-mobile-item device-home device-user">
				<a href="login.html"><span class="icon"><i
						class="fa fa-user" aria-hidden="true"></i></span>Account </a>
			</div>
		</div>
	</div>
