 ...
 */
@WebFilter(urlPatterns = {"/Activity_OP","/Activity","/CartServlet","/ExamController","/OrderServlet","/CourseServlet","/AdminServlet","/Loginservlet","/RegisterServlet","/ColumnServlet","/ColumnQueryAll.jsp"})
