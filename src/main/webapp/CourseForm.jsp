...
<body>
	...
	<form action=".\CourseServlet" method="post"
		...
		<table class=tb align='center'>
			...
			<tr>
				...
				<td><input type="text" name="course_name" size="30"
					maxlength="30" title="課程名稱"></td>
			</tr>
			<tr>
				<td>科目名稱:</td>
				<td>
					<!-- <input type="text" name="subject_id" size="2" maxlength="5" title="科目名稱代碼"> -->
			...
			<tr>
				<td>開課班別:</td>
				<td>
					<!-- <input type="text" name="education_id" size="2" maxlength="10" title="開課班別代碼"> -->
			...
			<tr>
				<td>課程簡介:</td>
				<td><textarea cols="10" rows="3" name="course_introduction"
						title="課程簡介"></textarea></td>
			</tr>
			<tr>
				<td>課程價格:</td>
			...
			<input type="hidden" name="enrollment" size="3" title="購買人數"
				value="0">
			...
			<tr>
				<td>講師信箱:</td>
				<td><input type="text" name="lecturer_email" size="10"
					title="講師信箱"></td>
			</tr>
			<tr>
				<td>課程封面圖片:</td>
		...
		<center>
			<br> <br> <input type="submit" name="submit" value="確定">
			<button type="reset" value="reset">
				清除 <i class="fa-solid fa-trash-can"></i>
			</button>
		</center>
