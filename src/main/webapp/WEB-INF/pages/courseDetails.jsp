                    ...
                    <div class="site-main">
                        <div class="details-product">
                            <div class="details-thumd">
                                <div class="image-preview-container image-thick-box image_preview_container"><img
                                        id="img_zoom" data-zoom-image="<%=courseBean.getCourse_picture() %>"
                                        src="<%=courseBean.getCourse_picture() %>" alt="img"><a href="#"
                                        class="btn-zoom open_qv"><i class="fa fa-search" aria-hidden="true"></i></a>
                                </div>
                            ...
                            <div class="details-infor">
                                ...
                                <div class="group-button">
                                    <div class="yith-wcwl-add-to-wishlist">
                                        <div class="yith-wcwl-add-button"><a href="#">加入最愛</a></div>
                                    </div>
                                    <div class="availability">課程價格:</div>
                                <div class="price"><span>$ <%=courseBean.getCourse_price() %></span></div>
                        ...
                        <div class="tab-details-product">
                            <ul class="tab-link">
                                <li class="active"><a data-toggle="tab" aria-expanded="true"><h3>課程簡介</h3></a></li>
                            </ul>
                            <div class="tab-container">
                                <div id="product-descriptions" class="tab-panel active">
                                    <p><center><h5>★ <%=courseBean.getCourse_introduction() %></h5></center></p>
