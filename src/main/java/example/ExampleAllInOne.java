...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String genAioCheckOutALL(){
		...
		obj.setMerchantTradeNo("xxxxxx21dxddxxxxxx");
		obj.setMerchantTradeDate(dateToStr);
		obj.setTotalAmount(String.valueOf(21312));
		obj.setTradeDesc("test Description");
		obj.setReturnURL("http://211.23.128.214:5000");
		obj.setNeedExtraPaidInfo("N");
		obj.setItemName("線上課程");
		obj.setClientBackURL("xxx");
		String form = all.aioCheckOut(obj, null);
		return form;
	}
//	public static String genAioCheckOutALL(){
//		AioCheckOutALL obj = new AioCheckOutALL();
//		obj.setMerchantTradeNo("testopaax0844x11xx");
...
//	}
	public static String genAioCheckOutApplePay(){
		...
		obj.setMerchantTradeNo("testapplc");
		obj.setMerchantTradeDate("2017/01/01 08:05:23");
		obj.setTotalAmount("50");
		obj.setTradeDesc("test Description");
